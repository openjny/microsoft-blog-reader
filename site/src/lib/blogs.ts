export const BLOG_METADATA: Record<string, { name: string; category: string }> = {
  ...
  adforpostgresql: {
    name: "Azure Database for Postgre SQL",
    category: "Database",
  },
  ...
  azurefederaldeveloperconnect: {
    name: "Azure Federal Developer Connect",
    category: "Development",
  },
  ...
  iltcommunicationblog: {
    name: "ILT Communication",
    category: "Communities",
  },
  integrationsonazureblog: {
    name: "Integrations on Azure",
    category: "Others",
  },
  ...
  microsoft365insiderblog: {
    name: "Microsoft 365 Insider",
    category: "Microsoft 365",
  },
  microsoft_365_archive_blog: {
    name: "Microsoft 365 Archive",
    category: "Microsoft 365",
  },
  microsoft_365_backup_blog: {
  ...
  microsoftteamscommunityblog: {
    name: "Microsoft Teams Community",
    category: "Productivity",
  },
  microsoftteamssupport: {
    name: "Microsoft Teams Support",
    category: "Productivity",
  },
  ...
  sharepoint_embedded: {
    name: "Share Point Embedded",
    category: "Productivity",
  },
  sharepoint_premium_blog: {
    name: "Share Point Premium",
    category: "Productivity",
  },
  skype_for_business_blog: {
 ...
 */
export function getBlogMetadata(slug: string): { name: string; category: string } | undefined {
